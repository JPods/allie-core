...
Experience applies intelligence with greater skill: a system that accumulates rated experience outperforms a system with a more capable model but no memory or retrospection of its own mistakes. No scars.
...
*Table 1: Four phases of competence mapped to Kahneman's System 1/System 2*
...
*Table 2: Structural correspondence between biological neural mechanisms and the episode architecture*

### 1.6. Why This Is Not Metaphor
...
*Table 3: Seven deployed agents with per-agent databases*
...
*Table 4: Comparison with existing agent memory approaches*
