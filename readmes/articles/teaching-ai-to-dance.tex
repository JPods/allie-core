...
Root-Bernstein et al.\ found that Nobel-winning scientists were 22 times more likely than other scientists to maintain serious performance avocations --- dancing, acting, magic (\textit{Journal of Psychology of Science and Technology}, 2008) \cite{rootbernstein2008}. Cross-domain practice builds neural pathways that pure domain expertise cannot. The dance floor builds neurons the lecture hall can't.
...
\bibitem{rootbernstein2008}
Root-Bernstein, R. et al. ``Arts Foster Scientific Success: Avocations of Nobel, National Academy, Royal Society, and Sigma Xi Members.'' \textit{Journal of Psychology of Science and Technology}, 1(2), 51--63, 2008.
