...
| 2026-07-05 | Noelle Draft: stations only — circles are the designer's job | Noelle can see corridors from data. She cannot see where corridors need to branch or loop — that requires local knowledge. Stations say "something should be here." Circles say "something connects here to there." The second is a design decision, not a data decision. |
