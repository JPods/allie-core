---
name: Tulsa network design — next session
description: Build Tulsa network using Noelle workflow; existing OK_Tulsa_2026-05-04.jpd (249 structures) as reference
type: project
---
...
- Before Tulsa: review readmes/49 stress test, gather data for the 18 objections
- CityTool wiring also pending (Census key saved, Claude key in wc_credentials.json)
