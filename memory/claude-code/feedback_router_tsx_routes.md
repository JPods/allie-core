...
- `WebClerk/frontend/src/routes/Router.tsx` — the actual BrowserRouter that renders pages at URLs
- `WebClerk/frontend/src/routes/protectedRoutesConfig.tsx` — used by WindowManager for in-app window resolution
