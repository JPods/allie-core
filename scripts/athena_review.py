...
Writes one entry to /Users/williamjames/Allie/config/agent_log.jsonl per review.
Writes approved/flagged actions to /Users/williamjames/Allie/config/action_queue.json.
...
def cmd_propose(args):
    ...
    if args.review_file:
        ...
        try:
            ...
            # Limit to 5000 chars to stay within model context windows
            # OSL: review this limit — see agent_log.jsonl osl-filed 2026-04-21
