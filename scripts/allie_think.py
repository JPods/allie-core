...
Examples:
  ...
  # Save output to file
  python3 allie_think.py compare --prompt "..." --out /Users/williamjames/Allie/today/comparison.md
"""
...
def get_sovereign_home(args_home=None) -> pathlib.Path:
    ...
    for c in [pathlib.Path("/Users/williamjames/Allie"), pathlib.Path.home() / "sovereign"]:
